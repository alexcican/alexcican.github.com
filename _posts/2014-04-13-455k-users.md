...
I was using Trakt’s API to grab the TV shows, and because of the overwhelming API requests, their servers had several outages (sorry, guys). GitHub, where the app is [being hosted](https://github.com/alexcican/tiii.me), passed this stress test with flying colours—not a single minute of downtime. Hat’s off to you.
...
Attached with that email was a 500 word document written by me, in which I talk about the app’s features, how I came up with the idea, how many days it took me to develop the app, and a few words about myself. I wrote that document in order to make it easier for the blogger to write about the app. I sent this email to twenty bloggers and had high expectations that the app will go viral.
...
<figcaption>Doge meme is happy.</figcaption>
...
Succeed in not only making it viral, but also creating revenue from it. People would be happy to pay for your app if it solves their problem and makes their life easier.
...
Don’t over look this step. It’s important for making a viral app. Help users rave about your app. They loved the experience and want to tell others about it. Make it easy for them to do so. Spend some time customising the sharing experience. Don’t just strap-on a sharing plugin with social buttons.
