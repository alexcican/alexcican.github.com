...
- **[User-Agent Switcher](https://chrome.google.com/webstore/detail/user-agent-switcher-for-c/) to evaluate how websites are rendered on other devices (Chrome DevTools also has this feature, but it’s hidden in the settings)**.
...
- **[Window Resizer](https://chrome.google.com/webstore/detail/window-resizer/) for resizing the browser window to specific resolutions**.
