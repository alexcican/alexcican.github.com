...
**[SublimeText](http://www.sublimetext.com/) for coding**. I spend my life in it, so I might as well make it look pretty. [Download my User settings](https://gist.github.com/alexcican/5248905). For CSS coding I use [SASS](http://sass-lang.com/) + [Compass](http://compass-style.org).
