...
}}}}$("#intro, #post section").css("height",a);$("#intro div, #post .cover").css("padding-top",padding);if(a>670&&a<750){$("#navigation").addClass("reduceNavHeight").removeClass("reduceMoreNavHeight");
