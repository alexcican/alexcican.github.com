...
document.getElementsByTagName("head")[0].appendChild(msViewportStyle);}var previousScroll=0,menuOffset=90,detachPoint=1000,hideShowOffset=6;$(window).scroll(function(){var b=$(this).scrollTop(),c=document.body.offsetHeight,d=window.innerHeight+window.scrollY,a=Math.abs(b-previousScroll);
clearTimeout($.data(this,"scrollTimer"));$.data(this,"scrollTimer",setTimeout(function(){$("#fullWidthContainer, #fullWidthDemoContainer").addClass("notScrolling");
},100));if((b<=0)||(d>=c-200)){}else{if(a>=35){$("#fullWidthContainer, #fullWidthDemoContainer").removeClass("notScrolling");}}if(!$("#mainNav").hasClass("expanded")){if(b>menuOffset){if(b>detachPoint){if(!$("#mainNav").hasClass("detached")){$("#mainNav").addClass("detached");
...
$("#fullWidthContainer section").on("click touchstart",function(b){if(b.metaKey||b.ctrlKey||b.shiftKey){}else{container=$(this);var a=container.offset().top-$(window).scrollTop();
