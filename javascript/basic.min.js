...
document.getElementsByTagName("head")[0].appendChild(msViewportStyle);}var previousScroll=0,menuOffset=90,detachPoint=850,hideShowOffset=6;$(window).scroll(function(){var b=$(this).scrollTop(),c=document.body.offsetHeight,d=window.innerHeight+window.scrollY,a=Math.abs(b-previousScroll);
